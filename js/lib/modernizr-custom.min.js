...
!function(e, t, n) {
    ...
    function u() {
        var e = t.body;
        return e || (e = l(_ ? "svg" : "body"),
        e.fake = !0),
        e
    }
    function c(e, n, r, o) {
        var i, a, s, c, f = "modernizr", d = l("div"), p = u();
        if (parseInt(r, 10))
            for (; r--; )
                s = l("div"),
                s.id = o ? o[r] : f + (r + 1),
    ...
    function g(e, t, o, i) {
        ...
        for (var f, d, p, m, g, v = ["modernizr", "tspan", "samp"]; !P.style && v.length; )
            f = !0,
            P.modElem = l(v.shift()),
    ...
    function v(e, t, n, o, i) {
        ...
        return r(t, "string") || r(t, "undefined") ? g(s, t, o, i) : (s = (e + " " + N.join(a + " ") + a).split(" "),
        d(s, t, n))
    }
    function y(e, t, r) {
        return v(e, n, n, t, r)
    ...
    _ || !function(e, t) {
        ...
        var c, f, d = "3.7.3", p = e.html5 || {}, m = /^<|^(?:button|map|select|textarea|object|iframe|option|optgroup)$/i, h = /^(?:a|b|code|div|fieldset|h1|h2|h3|h4|h5|h6|i|label|li|ol|p|q|span|strong|style|table|tbody|td|th|tr|ul)$/i, g = "_html5shiv", v = 0, y = {};
        !function() {
            try {
    ...
    E.prefixed = function(e, t, n) {
        return 0 === e.indexOf("@") ? z(e) : (-1 != e.indexOf("-") && (e = a(e)),
        t ? v(e, t, n) : v(e, "pfx"))
    }
    ;
    E.testAllProps = y,
